...
const Privacy = () => {
  return (
   <div className='privacy-wrapper'>
        ...
        <ul>
        <li>
        <p>By visiting this page on our website: <a href="https://recruns.pro" rel="external nofollow noopener" target="_blank">https://recruns.pro</a></p>
        </li>
        <li>
        <p>By mail: recruns@gmail.com</p>
        </li>
        </ul>
   </div>
 );
